...
class RecommendationContext:
    ...
    def __init__(self):
        ...
        self.question_depth = "beginner"  # beginner, intermediate, advanced
        self.interests = []
        self.decision_type = None  # learning, investment, analysis
...
class IntelligentRecommender:
    ...
    # Topic relationship map - what topics naturally connect
    TOPIC_RELATIONSHIPS = {
    ...
    def generate_recommendations(
        ...
        # User level appropriate follow-ups
...
class QuestionGenerator:
    ...
    # Topic relationships for context-aware generation
    TOPIC_CONTEXT = {
        "stocks": {
    ...
    def generate_contextual_questions(
        ...
        # Generate questions based on user level and topic context
        questions = []
    ...
    def _generate_beginner_questions(
        ...
        if language == "id":
            # Indonesian beginner questions with natural phrasing
            templates = [
            ...
            # English beginner questions with natural phrasing
            templates = [
...
def detect_language(text: str) -> str:
    """Intelligently detect if text is English or Indonesian"""
    indonesian_patterns = [
...
def get_gratitude_response(language: str = "en") -> str:
    """Get conversational gratitude response"""
...
def get_fallback_response(text: str, language: str = "en") -> str:
    ...
    # Check gratitude patterns first
    for key, response in fallback_dict.items():
        if key in text_lower:
            return response
    
    # Then check greeting patterns
...
def format_response_with_sources(answer: str, sources: list = None, language: str = "en") -> str:
    ...
    # Create natural source reference
...
def detect_human_expression(question: str, language: str = "en") -> Optional[Dict[str, str]]:
    ...
    expressions = {
        ...
        "small_talk": {
            "patterns": ["how are you", "how are you doing", "what's up", "what's new", "how's it going", "you there", "hello there",
                        "apa kabar", "gimana kabar", "apa ada yang baru", "bagaimana kabar"],
            "en": "I'm here and ready to help! What would you like to know about economics and investments?",
            "id": "Saya siap membantu! Apa yang ingin Anda ketahui tentang ekonomi dan investasi?"
        },
