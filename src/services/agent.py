...
class BatchEmailProcessor:
    ...
    async def process_batch(self, request: BatchEmailRequest) -> Dict[str, Any]:
    ...
    def _prepare_email_content(self, question: str, response: QueryResponse, subject: Optional[str] = None) -> str:
        """Prepare email content"""
        content = f"""
...
Best regards,
Economic & Investment Advisor AI

---
This is an automated response. Please consult with a financial advisor before making investment decisions.
"""
        return content
